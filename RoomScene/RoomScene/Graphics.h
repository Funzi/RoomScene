...
namespace PV112
{
	...
	struct graphicsObject
	{
		...
		graphicsObject(PV112Geometry geometryI, glm::mat4 modelMatrixI, GLuint model_matrix_locI, GLuint textureI)
		{
			geometry = geometryI;
			modelMatrix = modelMatrixI;
			model_matrix_loc = model_matrix_locI;
			texture = textureI;
		}
	};
	...
	public:
		...
		void OnMouseBottomChanged(int button, int state, int x, int y);
